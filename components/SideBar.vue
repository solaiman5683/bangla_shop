    ...
    <accordion>
      <accordion-item :openByDefault="true">
        ...
        <template slot="accordion-trigger">
          <h3
            class="bg-green w-full p-5 rounded-t-xl cursor-pointer flex justify-between"
          >
            Categories
        ...
        <template slot="accordion-content">
          <div class="border border-t-0 border-gray-100 p-6">
            <ul class="leading-10">
              <li>
                <accordion>
                  <accordion-item :openByDefault="true">
                    <template slot="accordion-trigger">
                      <div
                        class="flex w-full justify-between cursor-pointer items-center hover:text-green-600"
                      >
                        Fruits
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <nuxt-link class="hover:text-green-600" to="/"
                  >Vegetables</nuxt-link
                >
              </li>
              <li>
                <nuxt-link class="hover:text-green-600" to="/"
                  >Lorem category</nuxt-link
                >
              </li>
            </ul>
          </div>
